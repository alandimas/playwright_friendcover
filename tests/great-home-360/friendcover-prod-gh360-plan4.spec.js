...
test('Great Home 360 Plan 4', async ({ page }) => {
    ...
    const premiumBtn = page.getByRole('button', {
        name: 'RM685.19 Yearly Premium (Subject to SST & Stamp Duty)'});
    await premiumBtn.click();

    // input contact detail
    await page.locator("//input[@name='fullName']").fill('Automate Test Home Plan Four');
