...
test('Great Home 360 Plan 1', async ({ page }) => {
    ...
    const premiumBtn = page.getByRole('button', {
        name: 'RM314.82 Yearly Premium (Subject to SST & Stamp Duty)'});
    await premiumBtn.click();

    // input contact detail
    await page.locator("//input[@name='fullName']").fill('Automate Test Home Plan One');
