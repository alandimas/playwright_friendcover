...
test('Great Shield Active Plan 3', async ({ page }) => {
    ...
    await page.locator("//input[@name='fullName']").fill('Automate GSA Plan Three');
    ...
    const paymentAmount = page.getByText('MYR 395.13', {
        exact: true
    });
