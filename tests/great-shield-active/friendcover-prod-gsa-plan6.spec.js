...
test('Great Shield Active Plan 6', async ({ page }) => {
    ...
    await page.locator("//input[@name='fullName']").fill('Automate GSA Plan Six');
    ...
    const paymentAmount = page.getByText('MYR 986.07', {
        exact: true
    });
