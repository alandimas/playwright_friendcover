...
test('Great Shield Active Plan 1', async ({ page }) => {
    ...
    await page.locator("//input[@name='fullName']").fill('Automate GSA Plan One');
    ...
    const paymentAmount = page.getByText('MYR 160.98', {
        exact: true
    });
