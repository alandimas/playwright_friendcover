...
test('Great Shield Active Plan 5', async ({ page }) => {
    ...
    await page.locator("//input[@name='fullName']").fill('Automate GSA Plan Five');
    ...
    const paymentAmount = page.getByText('MYR 823.06', {
        exact: true
    });
