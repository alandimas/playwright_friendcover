...
test('Great Shield Active Plan 4', async ({ page }) => {
    ...
    await page.locator("//input[@name='fullName']").fill('Automate GSA Plan Four');
    ...
    const paymentAmount = page.getByText('MYR 517.39', {
        exact: true
    });
