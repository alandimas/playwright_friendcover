...
test('Great Shield Active Plan 2', async ({ page }) => {
    ...
    await page.locator("//input[@name='fullName']").fill('Automate GSA Plan Two');
    ...
    const paymentAmount = page.getByText('MYR 272.87', {
        exact: true
    });
